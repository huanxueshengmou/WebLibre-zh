...
enum TabBarPositionSetting {
  ...
  String get description => switch (this) {
    auto => tr("A side rail on large screens, a bottom bar on phones"),
    top => tr("Persistent tab bar without auto-hide"),
    bottom => tr("Tab bar with auto-hide support"),
    left => tr("Vertical side rail, swipe to hide"),
    right => tr("Vertical side rail, swipe to hide"),
  };
