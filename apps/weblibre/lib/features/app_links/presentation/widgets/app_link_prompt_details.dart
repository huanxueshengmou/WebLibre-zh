  ...
  return [
    ...
    if (request.isProtectedContext)
      AppLinkPromptWarning(
        ...
        message:
            tr("This link is protected here. The app opens its own connection, outside the rules this tab follows."),
      ),
    if (request.isPrivate)
      AppLinkPromptWarning(
        icon: Icons.visibility_off_outlined,
        message:
            tr("This is a private tab. The app keeps its own history and sign-in state."),
      ),
    if (request.isWallet)
      AppLinkPromptWarning(
        icon: Icons.badge_outlined,
        message:
            tr("This link asks a wallet app for credentials. Open it only if you started this."),
      ),
  ];
}
