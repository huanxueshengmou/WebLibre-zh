...
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): GeckoEngineSettings {
      ...
      val userAgent = pigeonVar_list[9] as String?
      val contentBlocking = pigeonVar_list[10] as ContentBlocking?
      val enterpriseRootsEnabled = pigeonVar_list[11] as Boolean?
      val dohSettings = pigeonVar_list[12] as DohSettings?
      val fingerprintingProtectionOverrides = pigeonVar_list[13] as String?
      val locales = pigeonVar_list[14] as List<String>?
      val useContentBlockingDatabase = pigeonVar_list[15] as Boolean?
      ...
      val blockAdsAnalyticsSocialTrackers = pigeonVar_list[27] as Boolean?
      val webFontsEnabled = pigeonVar_list[28] as Boolean?
      val automaticFontSizeAdjustment = pigeonVar_list[29] as Boolean?
      val fontSizeFactor = pigeonVar_list[30] as Double?
      val fontInflationEnabled = pigeonVar_list[31] as Boolean?
      val displayDensityOverride = pigeonVar_list[32] as Double?
      val screenWidthOverride = pigeonVar_list[33] as Long?
      val screenHeightOverride = pigeonVar_list[34] as Long?
      val inputAutoZoomEnabled = pigeonVar_list[35] as Boolean?
      val forceUserScalableContent = pigeonVar_list[36] as Boolean?
...
data class GeckoProxyRoutingSnapshot (
   ...
   */
  val awaitingProxyIds: List<String>
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): GeckoProxyRoutingSnapshot {
      ...
      val awaitingProxyIds = pigeonVar_list[6] as List<String>
      return GeckoProxyRoutingSnapshot(generation, proxies, relations, directScopes, siteAssignments, strictContexts, awaitingProxyIds)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun hashCode(): Int {
    ...
    result = 31 * result + GeckoPigeonUtils.deepHash(this.awaitingProxyIds)
    return result
  }
  override fun toString(): String {
    return "GeckoProxyRoutingSnapshot(generation=$generation, proxies=$proxies, relations=$relations, directScopes=$directScopes, siteAssignments=$siteAssignments, strictContexts=$strictContexts, awaitingProxyIds=$awaitingProxyIds)"
  }
}
...
data class GeckoRoutingDemand (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): GeckoRoutingDemand {
      val contextId = pigeonVar_list[0] as String
      val proxyIds = pigeonVar_list[1] as List<String>
      return GeckoRoutingDemand(contextId, proxyIds)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as GeckoRoutingDemand
    return GeckoPigeonUtils.deepEquals(this.contextId, other.contextId) && GeckoPigeonUtils.deepEquals(this.proxyIds, other.proxyIds)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + GeckoPigeonUtils.deepHash(this.contextId)
    result = 31 * result + GeckoPigeonUtils.deepHash(this.proxyIds)
    return result
  }
  override fun toString(): String {
    return "GeckoRoutingDemand(contextId=$contextId, proxyIds=$proxyIds)"
  }
}
...
interface GeckoSyncApi {
  ...
  suspend fun beginPairingAuthentication(pairingUrl: String)
  suspend fun logout()
  suspend fun syncNow()
  suspend fun setEngineEnabled(engine: SyncEngineValue, enabled: Boolean)
  suspend fun getSyncedTabs(): List<SyncDeviceTabs>
  suspend fun getDevices(): List<SyncDevice>
  suspend fun sendTabToDevice(deviceId: String, title: String, url: String, private: Boolean): Boolean
  suspend fun refreshDevices()
  suspend fun pollDeviceCommands()
  suspend fun drainIncomingTabs(): List<SyncIncomingTab>
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.beginPairingAuthentication(pairingUrlArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.setEngineEnabled(engineArg, enabledArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.sendTabToDevice(deviceIdArg, titleArg, urlArg, privateArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.setDeviceName(newNameArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoSessionApi {
  ...
  suspend fun requestScreenshot(sendBack: Boolean): ByteArray?
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.requestScreenshot(sendBackArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoIconsApi {
  suspend fun loadIcon(request: IconRequest): IconResult
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.loadIcon(requestArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoPrefApi {
  suspend fun getPrefs(preferenceFilter: List<String>): Map<String, GeckoPref>
  suspend fun applyPrefs(prefs: Map<String, Any>): Map<String, GeckoPref>
  suspend fun resetPrefs(preferenceNames: List<String>)
  fun startObserveChanges()
  fun stopObserveChanges()
  suspend fun registerPrefForObservation(name: String)
  suspend fun unregisterPrefForObservation(name: String)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getPrefs(preferenceFilterArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.applyPrefs(prefsArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.resetPrefs(preferenceNamesArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.registerPrefForObservation(nameArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.unregisterPrefForObservation(nameArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
...
interface GeckoMlApi {
  suspend fun predictDocumentTopic(documents: List<String>): String
  suspend fun generateDocumentEmbeddings(documents: List<String>): List<Any?>
  suspend fun clearMlCache()
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.predictDocumentTopic(documentsArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.generateDocumentEmbeddings(documentsArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoBrowserExtensionApi {
  suspend fun getMarkdown(htmlList: List<String>): List<Any>
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getMarkdown(htmlListArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoContainerProxyApi {
   ...
   */
  suspend fun applySnapshot(snapshot: GeckoProxyRoutingSnapshot): Long
  /**
   ...
   */
  fun takeRoutingDemand(): GeckoRoutingDemand?
  /**
   ...
   */
  suspend fun nextRoutingDemand(): GeckoRoutingDemand
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: GeckoContainerProxyApi?, messageChannelSuffix: String = "") {
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.applySnapshot(snapshotArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.flutter_mozilla_components.GeckoContainerProxyApi.takeRoutingDemand$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              listOf(api.takeRoutingDemand())
            } catch (exception: Throwable) {
              GeckoPigeonUtils.wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.flutter_mozilla_components.GeckoContainerProxyApi.nextRoutingDemand$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.nextRoutingDemand())
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoCookieApi {
  suspend fun getCookie(firstPartyDomain: String?, name: String, partitionKey: CookiePartitionKey?, storeId: String?, url: String): Cookie
  suspend fun getAllCookies(domain: String?, firstPartyDomain: String?, name: String?, partitionKey: CookiePartitionKey?, storeId: String?, url: String): List<Cookie>
  suspend fun setCookie(domain: String?, expirationDate: Long?, firstPartyDomain: String?, httpOnly: Boolean?, name: String?, partitionKey: CookiePartitionKey?, path: String?, sameSite: CookieSameSiteStatus?, secure: Boolean?, storeId: String?, url: String, value: String?)
  suspend fun removeCookie(firstPartyDomain: String?, name: String, partitionKey: CookiePartitionKey?, storeId: String?, url: String)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getCookie(firstPartyDomainArg, nameArg, partitionKeyArg, storeIdArg, urlArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getAllCookies(domainArg, firstPartyDomainArg, nameArg, partitionKeyArg, storeIdArg, urlArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.setCookie(domainArg, expirationDateArg, firstPartyDomainArg, httpOnlyArg, nameArg, partitionKeyArg, pathArg, sameSiteArg, secureArg, storeIdArg, urlArg, valueArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.removeCookie(firstPartyDomainArg, nameArg, partitionKeyArg, storeIdArg, urlArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
...
interface GeckoAddonsApi {
  suspend fun getAddons(allowCache: Boolean): List<AddonInfo>
  suspend fun getAddonById(addonId: String, allowCache: Boolean): AddonInfo?
  suspend fun getAddonStoreInfo(addonId: String): AddonStoreInfo?
  suspend fun searchAddonListings(query: String, app: AddonStoreApp, page: Long, pageSize: Long): List<AddonListing>
  suspend fun getFeaturedAddonListings(app: AddonStoreApp, pageSize: Long): List<AddonListing>
  fun invokeAddonAction(extensionId: String, actionType: WebExtensionActionType)
  suspend fun enableAddon(addonId: String): AddonInfo
  suspend fun disableAddon(addonId: String): AddonInfo
  suspend fun setAddonAllowedInPrivateBrowsing(addonId: String, allowed: Boolean): AddonInfo
  suspend fun setAddonAutoUpdateEnabledForAddon(addonId: String, enabled: Boolean): AddonInfo
  suspend fun uninstallAddon(addonId: String)
  suspend fun triggerAddonUpdate(addonId: String): AddonUpdateAttemptInfo?
  suspend fun triggerAllAddonUpdates()
  suspend fun getLastAddonUpdateAttempt(addonId: String): AddonUpdateAttemptInfo?
  suspend fun installAddon(url: String)
  suspend fun isAddonAutoUpdateEnabled(): Boolean
  suspend fun setAddonAutoUpdateEnabled(enabled: Boolean)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getAddons(allowCacheArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getAddonById(addonIdArg, allowCacheArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getAddonStoreInfo(addonIdArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.searchAddonListings(queryArg, appArg, pageArg, pageSizeArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getFeaturedAddonListings(appArg, pageSizeArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.enableAddon(addonIdArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.disableAddon(addonIdArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.setAddonAllowedInPrivateBrowsing(addonIdArg, allowedArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.setAddonAutoUpdateEnabledForAddon(addonIdArg, enabledArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.triggerAddonUpdate(addonIdArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getLastAddonUpdateAttempt(addonIdArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.isAddonAutoUpdateEnabled())
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.setAddonAutoUpdateEnabled(enabledArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getAutocompleteSuggestion(queryArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoDeleteBrowsingDataController {
  ...
  suspend fun clearDataForSessionContext(contextId: String)
  /** Clear browsing data for a specific host/domain */
  suspend fun clearDataForHost(host: String, dataTypes: List<ClearDataType>)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.clearDataForSessionContext(contextIdArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.clearDataForHost(hostArg, dataTypesArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
...
interface GeckoHistoryApi {
  suspend fun getDetailedVisits(startMillis: Long, endMillis: Long, excludeTypes: List<VisitType>): List<VisitInfo>
   ...
   * roundtrips into one.
   */
  suspend fun getLatestHistoryMetadataForUrls(urls: List<String>): List<HistoryMetadata?>
  /**
   * Bulk visited check: returns booleans aligned with [urls] indicating
   * whether Places has any visit recorded for each URL.
   */
  suspend fun getVisited(urls: List<String>): List<Boolean>
  /** Frecency-ranked autocomplete results. Mirrors Places' awesomebar input. */
  suspend fun getSuggestions(query: String, limit: Long): List<HistorySuggestion>
  /**
   ...
   */
  suspend fun recordObservation(url: String, observation: PageObservation)
  /**
   * Records a view-time observation against the metadata record identified
   * by [key]. View time is added to the existing total.
   */
  suspend fun noteHistoryMetadataViewTime(key: HistoryMetadataKey, viewTimeMs: Long)
  /**
   * Records a document-type observation against the metadata record
   * identified by [key].
   */
  suspend fun noteHistoryMetadataDocumentType(key: HistoryMetadataKey, documentType: DocumentType)
   ...
   */
  suspend fun deleteVisitsSince(sinceMillis: Long)
  /**
  ...
  suspend fun deleteHistoryMetadataOlderThan(olderThanMillis: Long)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getDetailedVisits(startMillisArg, endMillisArg, excludeTypesArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getVisitsPaginated(offsetArg, countArg, excludeTypesArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.deleteVisit(urlArg, timestampArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.deleteVisitsBetween(startMillisArg, endMillisArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getHistoryHighlights(weightsArg, limitArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getTopFrecentSites(limitArg, frecencyThresholdArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getLatestHistoryMetadataForUrl(urlArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getLatestHistoryMetadataForUrls(urlsArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getSuggestions(queryArg, limitArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.queryHistoryMetadata(queryArg, limitArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.recordObservation(urlArg, observationArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.noteHistoryMetadataViewTime(keyArg, viewTimeMsArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.noteHistoryMetadataDocumentType(keyArg, documentTypeArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.deleteVisitsSince(sinceMillisArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.deleteHistoryMetadataOlderThan(olderThanMillisArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
...
interface GeckoFetchApi {
  suspend fun fetch(request: GeckoFetchRequest): GeckoFetchResponse
...
interface GeckoBookmarksApi {
   ...
   */
  suspend fun getTree(guid: String, recursive: Boolean): BookmarkNode?
  /**
   ...
   */
  suspend fun getRecentBookmarks(limit: Long, maxAge: Long?, currentTime: Long): List<BookmarkNode>
  /**
   ...
   */
  suspend fun searchBookmarks(query: String, limit: Long): List<BookmarkNode>
  /**
   ...
   */
  suspend fun addItem(parentGuid: String, url: String, title: String, position: Long?): String
  /**
   ...
   * @return The guid of the newly inserted bookmark item.
   */
  suspend fun addFolder(parentGuid: String, title: String, position: Long?): String
  /**
   ...
   */
  suspend fun insertTree(parentGuid: String, children: List<BookmarkImportNode>): BookmarkInsertTreeResult
  /**
   ...
   */
  suspend fun countBookmarksInTrees(guids: List<String>): Long
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getTree(guidArg, recursiveArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getBookmark(guidArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getBookmarksWithUrl(urlArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getRecentBookmarks(limitArg, maxAgeArg, currentTimeArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.searchBookmarks(queryArg, limitArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.addItem(parentGuidArg, urlArg, titleArg, positionArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.addFolder(parentGuidArg, titleArg, positionArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.updateNode(guidArg, infoArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.insertTree(parentGuidArg, childrenArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.countBookmarksInTrees(guidsArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoSitePermissionsApi {
  ...
  suspend fun getSitePermissions(origin: String, private: Boolean): SitePermissions?
  /** Save/update permissions (persisted by GeckoView) */
  suspend fun setSitePermissions(permissions: SitePermissions, private: Boolean)
  /** Delete permissions for origin (removed from GeckoView storage) */
  suspend fun deleteSitePermissions(origin: String, private: Boolean)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getSitePermissions(originArg, privateArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.setSitePermissions(permissionsArg, privateArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.deleteSitePermissions(originArg, privateArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
...
interface GeckoPublicSuffixListApi {
   ...
   */
  suspend fun getPublicSuffixPlusOne(host: String): String
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getPublicSuffixPlusOne(hostArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoTrackingProtectionApi {
   ...
   */
  suspend fun containsException(tabId: String): Boolean
  /**
   ...
   */
  suspend fun removeExceptionByUrl(url: String)
  /**
   * Fetch all tracking protection exceptions
   *
   * Returns list of all sites that have exceptions (ETP disabled).
   */
  suspend fun fetchExceptions(): List<TrackingProtectionException>
  /**
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.containsException(tabIdArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.removeExceptionByUrl(urlArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
...
interface GeckoAppLinksApi {
   ...
   */
  suspend fun setAppLinkPolicy(snapshot: AppLinkPolicySnapshot)
  /**
   ...
   */
  suspend fun getPendingAppLinkPrompts(owner: AppLinkPromptOwner): List<AppLinkPromptRequest>
  /**
   ...
   */
  suspend fun resolvePendingAppLink(requestId: Long, decision: AppLinkDecision): AppLinkResolutionResult
  /**
   ...
   */
  suspend fun resolveAppLink(url: String, includeHttpAppLinks: Boolean): AppLinkTarget?
  /**
   ...
   */
  suspend fun launchAppLink(url: String): Boolean
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.setAppLinkPolicy(snapshotArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getPendingAppLinkPrompts(ownerArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.resolvePendingAppLink(requestIdArg, decisionArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.resolveAppLink(urlArg, includeHttpAppLinksArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.launchAppLink(urlArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoPwaApi {
   ...
   */
  suspend fun installWebApp(tabId: String?, profileUuid: String, contextId: String?, overrideAppName: String?): Boolean
  /** Returns a list of all installed PWA manifests. */
  suspend fun getInstalledWebApps(): List<PwaManifest>
  /**
   ...
   */
  suspend fun installBasicShortcut(tabId: String?, profileUuid: String, contextId: String?, overrideShortcutName: String?): Boolean
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.installWebApp(tabIdArg, profileUuidArg, contextIdArg, overrideAppNameArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.getInstalledWebApps())
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                listOf(api.installBasicShortcut(tabIdArg, profileUuidArg, contextIdArg, overrideShortcutNameArg))
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
              reply.reply(wrapped)
...
interface GeckoPushApi {
  suspend fun getPushStatus(): PushStatus
  /**
   ...
   */
  suspend fun setDistributor(packageName: String)
  /** Forgets the current distributor. This is the off switch for web push. */
  suspend fun removeDistributor()
   ...
   */
  suspend fun suspendPushForRestart()
  /**
      ...
      run {
        ...
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            ...
            CoroutineScope(Dispatchers.Main).launch {
              val wrapped: List<Any?> = try {
                api.setDistributor(packageNameArg)
                listOf(null)
              } catch (exception: Throwable) {
                GeckoPigeonUtils.wrapError(exception)
              }
