...
abstract class PointerInputFlutterApi {
  ...
  Future<PointerHitTest> hitTest(double x, double y, bool tracksHover);

  /// The cursor left every registered surface, so the stationary watch stops.
  Future<void> pointerExit();
        ...
        : '';
    {
      ...
      if (api == null) {
        ...
        pigeonVar_channel.setMessageHandler((Object? message) async {
          ...
          try {
            final PointerHitTest output = await api.hitTest(
              arg_x,
              arg_y,
              arg_tracksHover,
            );
