...
class ToolbarButtonConfigs extends Table
  ...
  late final GeneratedColumn<String> longPressAction = GeneratedColumn<String>(
    'long_press_action',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  ToolbarButtonConfigsData map(
    ...
    return ToolbarButtonConfigsData(
      ...
      longPressAction: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class ToolbarButtonConfigsData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || longPressAction != null) {
      map['long_press_action'] = Variable<String>(longPressAction);
    }
    return map;
  }
  ...
  factory ToolbarButtonConfigsData.fromJson(
    ...
    return ToolbarButtonConfigsData(
      ...
      longPressAction: serializer.fromJson<String?>(json['longPressAction']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'longPressAction': serializer.toJson<String?>(longPressAction),
    };
  }
  ...
  ToolbarButtonConfigsData copyWith({
    ...
    Value<String?> longPressAction = const Value.absent(),
...
class ToolbarButtonConfigsCompanion
  ...
  final Value<String?> longPressAction;
  final Value<int> rowid;
  const ToolbarButtonConfigsCompanion({
    ...
    this.longPressAction = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  ...
  static Insertable<ToolbarButtonConfigsData> custom({
    ...
    Expression<String>? longPressAction,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (longPressAction.present) {
      map['long_press_action'] = Variable<String>(longPressAction.value);
    }
    if (rowid.present) {
      map['rowid'] = Variable<int>(rowid.value);
    }
