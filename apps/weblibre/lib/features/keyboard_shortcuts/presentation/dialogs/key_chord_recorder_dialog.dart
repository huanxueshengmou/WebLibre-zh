...
class KeyChordRecorderDialog extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final problem = switch (chord) {
      ...
      _ when !chord.isAssignable =>
        'Web pages need this key. Hold Ctrl, Alt or Meta with it, or use a '
            'function key.',
      _ when owner == action => tr("This is already a shortcut for this action."),
      _ => null,
    };
    ...
    return Focus(
      ...
      child: AlertDialog(
        title: Text(replacing == null ? tr("Add shortcut") : tr("Change shortcut")),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text(
              tr("Press the key combination for \"{0}\".", [action.title]),
            ...
            Container(
              ...
              child: Text(
                chord?.label ?? tr("Waiting for keys…"),
            ...
            if (problem != null) ...[
              ...
              const SizedBox(height: 12),
              Text(
                tr("Currently used by \"{0}\". Saving moves it here.", [owner.title]),
        ...
        actions: [
          ...
          FilledButton(
            ...
            child: Text(takesFromOther ? tr("Reassign") : tr("Save")),
          ),
        ],
      ),
    );
